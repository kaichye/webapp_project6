...
!(function (n) {
    ...
    var C,
                          ...
                          var F,
                                          ...
                                          .each(function (e, t) {
                                              ...
                                              a || Z(u, 0, "Incorrect column count", 18),
                                                  a.mData === e &&
                                                      ...
                                                      (null === n && null === t) ||
                                                          ((a.mData = { _: e + ".display", sort: null !== n ? e + ".@data-" + n : void 0, type: null !== n ? e + ".@data-" + n : void 0, filter: null !== t ? e + ".@data-" + t : void 0 }),
                                                          (a._isArrayHost = !0),
                                                          oe(u, e)));
                                          })),
                                  u.oFeatures),
                              O = function () {
                                  ...
                                  var t = o.children("caption"),
                                      t =
                                          (u.caption && (t = 0 === t.length ? B("<caption/>").appendTo(o) : t).html(u.caption),
                                          t.length && ((t[0]._captionSide = t.css("caption-side")), (u.captionNode = t[0])),
                                  ...
                                  if ((0 === t.length && (t = B("<tfoot/>").appendTo(o)), (u.nTFoot = t[0]), B("tr", t).addClass(c.tfoot.row), n.aaData)) for (a = 0; a < n.aaData.length; a++) Y(u, n.aaData[a]);
                              ...
                              n.bStateSave
                                  ? ((R.bStateSave = !0),
                                    ...
                                    (L = u).oFeatures.bStateSave
                                        ? void 0 !==
                                              (j = L.fnStateLoadCallback.call(L.oInstance, L, function (e) {
                                                  Ye(L, e, N);
                                              })) && Ye(L, j, N)
                                        : N())
                                  : O();
        ...
        s =
            ...
            B.extend(C, { afnFiltering: C.search, aTypes: C.type.detect, ofnSearch: C.type.search, oSort: C.type.order, afnSortData: C.order, aoFeatures: C.feature, oStdClasses: C.classes, oPagination: C.pager }),
        ...
        h = function (e, t, n) {
            var a = [],
                r = 0,
                o = e.length;
            if (void 0 !== n) for (; r < o; r++) e[r] && e[r][t] && a.push(e[r][t][n]);
                ...
                : ((f = function (e, t, n) {
                      for (var a, r, o, i, l = de(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
                          ...
                          if (((a = l[s].match(ce)), (r = l[s].match(p)), a)) {
                              if (((l[s] = l[s].replace(ce, "")), (e[l[s]] = []), (a = l.slice()).splice(0, s + 1), (i = a.join(".")), Array.isArray(t))) for (var c = 0, d = t.length; c < d; c++) f((o = {}), t[c], i), e[l[s]].push(o);
                              else e[l[s]] = t;
                              return;
                          }
                      ...
                      if ("" !== n)
                          for (var i = de(n), l = 0, s = i.length; l < s; l++) {
                              if (((d = i[l].match(ce)), (a = i[l].match(p)), d)) {
                                  if (((i[l] = i[l].replace(ce, "")), "" !== i[l] && (e = e[i[l]]), (r = []), i.splice(0, l + 1), (o = i.join(".")), Array.isArray(e))) for (var u = 0, c = e.length; u < c; u++) r.push(f(e[u], t, o));
            ...
            for (
                f.append(B(t.nTHead).clone()).append(B(t.nTFoot).clone()),
                    ...
                    f.find("thead th, thead td").each(function () {
                        var e = ie(t, this, !0, !1);
                        e ? ((this.style.width = e), s && B(this).append(B("<div/>").css({ width: e, margin: 0, padding: 0, border: 0, height: 1 }))) : (this.style.width = "");
                    }),
                    n = 0;
                n < u.length;
                n++
                ...
                B("<td/>").addClass(g).addClass(a.sClass).attr("draggable", true).append(p).appendTo(h);
            }
    ...
    function Y(e, t, n, a) {
        for (var r = e.aoData.length, o = B.extend(!0, {}, $.models.oRow, { src: n ? "dom" : "data", idx: r }), i = ((o._aData = t), e.aoData.push(o), e.aoColumns), l = 0, s = i.length; l < s; l++) i[l].sType = null;
    ...
    function G(e, t, n, a) {
        ...
        if (void 0 === (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s))
            return e.iDrawError != r && null === l && (Z(e, 0, "Requested unknown parameter " + ("function" == typeof o.mData ? "{function}" : "'" + o.mData + "'") + " for row " + t + ", column " + n, 4), (e.iDrawError = r)), l;
    ...
    function ge(e, t, n, a) {
        ...
        function o(e) {
            (void 0 !== n && n !== d) ||
                ((l = f[d]), (s = e.innerHTML.trim()), l && l._bAttrSrc ? (m(l.mData._)(a, s), r(l.mData.sort, e), r(l.mData.type, e), r(l.mData.filter, e)) : h ? (l._setter || (l._setter = m(l.mData)), l._setter(a, s)) : (a[d] = s)),
                d++;
        }
        var i,
            l,
        ...
        return t && (t = t.getAttribute("id")) && m(e.rowId)(a, t), { data: a, cells: u };
    }
    function me(e, t) {
        var n = e.aoData[t],
            a = e.aoColumns;
    ...
    function ve(e, t, n, a) {
        ...
        if (null === c.nTr) {
            for (r = n || _.createElement("tr"), c.nTr = r, c.anCells = f, D(r, h), r._DT_RowIndex = t, be(e, c), l = 0, s = e.aoColumns.length; l < s; l++) {
                (i = e.aoColumns[l]), (o = (u = !n) ? _.createElement(i.sCellType) : a[l]) || Z(e, 0, "Incorrect column count", 18), (o._DT_CellIndex = { row: t, column: l }), f.push(o);
                var p = me(e, t);
    ...
    function be(e, t) {
        ...
        n &&
            ...
            a.DT_RowClass && ((e = a.DT_RowClass.split(" ")), (t.__rowc = t.__rowc ? x(t.__rowc.concat(e)) : e), B(n).removeClass(t.__rowc.join(" ")).addClass(a.DT_RowClass)),
    ...
    function Se(e) {
        var t = e.oLanguage,
            ...
            a = te(e);
        return (
            e.iDraw <= 1 && ("ajax" === a || "ssp" === a) ? (n = t.sLoadingRecords) : t.sEmptyTable && 0 === e.fnRecordsTotal() && (n = t.sEmptyTable),
            B("<tr/>").append(B("<td />", { colSpan: H(e), class: e.oClasses.empty.row }).html(n))[0]
        );
    }
    function Te(e, t, n) {
        for (
            ...
            r[i].val.full && (o.push({ full: r[i].val.full }), we(e, o[o.length - 1]), delete r[i].val.full), Object.keys(r[i].val).length && (o.push(r[i].val), we(e, o[o.length - 1]));
        return o;
    }
    function we(o, i) {
        function l(e, t) {
            ...
            for (var t, n = i[e].contents, a = 0, r = n.length; a < r; a++)
                n[a] &&
                    ("string" == typeof n[a]
                        ...
                        ? (n[a] = n[a].node(o))
                        : "function" == typeof n[a] && ((t = n[a](o)), (n[a] = "function" == typeof t.node ? t.node() : t)));
        });
    }
    function _e(t) {
        var a,
            ...
            for (var i, l, s, u, c, d, f = t, h = t.sDom, p = r, g = h.match(/(".*?")|('.*?')|./g), m = 0; m < g.length; m++)
                (i = null),
                    "<" == (l = g[m])
                        ? ((s = B("<div/>")),
                          ("'" != (u = g[m + 1])[0] && '"' != u[0]) ||
                              ((u = u.replace(/['"]/g, "")), (c = ""), -1 != u.indexOf(".") ? ((d = u.split(".")), (c = d[0]), (d = d[1])) : "#" == u[0] ? (c = u) : (d = u), s.attr("id", c.substring(1)).addClass(d), m++),
                          p.append(s),
                          (p = s))
                        : ">" == l
                        ? (p = p.parent())
        ...
        h.oFeatures.bProcessing &&
            ((a = B("<div/>", { id: h.sTableId + "_processing", class: h.oClasses.processing.container, role: "status" })
                        ...
                        b = (b = +r.getAttribute("colspan")) && 0 != b && 1 != b ? b : 1,
                            ...
                            n &&
                                (s &&
                                    ...
                                    d ? (null === g.sTitle || g.autoTitle || (r.innerHTML = g.sTitle), !g.sTitle && s && ((g.sTitle = r.innerHTML.replace(/<.*?>/g, "")), (g.autoTitle = !0))) : g.footer && (r.innerHTML = g.footer),
    ...
    function Ie(n, e, a) {
        ...
        var r,
            ...
            i = n.oInstance,
            l =
                (B.isPlainObject(o) && o.data && ((l = "function" == typeof (r = o.data) ? r(e, n) : r), (e = "function" == typeof r && l ? l : B.extend(!0, e, l)), delete o.data),
                {
    ...
    function Ae(e, t, n) {
        var a = "data";
        if ((B.isPlainObject(e.ajax) && void 0 !== e.ajax.dataSrc && ("string" == typeof (e = e.ajax.dataSrc) || "function" == typeof e ? (a = e) : void 0 !== e.data && (a = e.data)), !n))
                ...
                if (c[d] && !(l = c[d])._aFilterData) {
                    for (o = [], a = 0, r = u.length; a < r; a++)
                        u[a].bSearchable ? "string" != typeof (i = null === (i = G(s, d, a, "filter")) ? "" : i) && i.toString && (i = i.toString()) : (i = ""),
                            i.indexOf && -1 !== i.indexOf("&") && ((Pe.innerHTML = i), (i = Re ? Pe.textContent : Pe.innerText)),
                ...
                var o = 0,
                    ...
                    l =
                        n instanceof RegExp
                            ...
                            : (function (e, t) {
                                  var a = [],
                                      t = B.extend({}, { boundary: !1, caseInsensitive: !0, exact: !1, regex: !1, smart: !0 }, t);
    ...
    function We(e) {
        ...
        e.scrollBarVis !== p && void 0 !== e.scrollBarVis
            ...
            : ((e.scrollBarVis = p),
              ...
              f && (u.css("width", A(n)), s.css("width", A(n)).css(p, c ? a + "px" : "0px")),
                        ...
                        !(function (e, t, n) {
                            ...
                            o.bSortable &&
                                ...
                                n && e.oFeatures.bSortMulti
                                    ? -1 !== (o = h(i, "0").indexOf(t))
                                        ? null === (r = null === (r = a(i[o], !0)) && 1 === i.length ? 0 : r)
                                            ? i.splice(o, 1)
                                            : ((i[o][1] = l[r]), (i[o]._idx = r))
                                        : (i.push([t, l[0], 0]), (i[i.length - 1]._idx = 0))
                                    : i.length && i[0][0] == t
                                    ? ((r = a(i[0])), (i.length = 1), (i[0][1] = l[r]), (i[0]._idx = r))
                ...
                if (c[(l = h[t][0])])
                    for (n = 0, a = (r = c[l].aDataSort).length; n < a; n++)
                        (i = c[(o = r[n])].sType || "string"),
                            ...
                            h[t][1] && s.push({ src: l, col: o, dir: h[t][1], index: h[t]._idx, type: i, formatter: u[i + "-pre"], sorter: u[i + "-" + h[t][1]] });
        return s;
    }
    function Ue(e, t, n) {
        var a,
            ...
            u = e.aiDisplayMaster;
        for (
            X(e), void 0 !== t ? ((l = e.aoColumns[t]), (c = [{ src: t, col: t, dir: n, index: 0, type: l.sType, formatter: s[l.sType + "-pre"], sorter: s[l.sType + "-" + n] }]), (u = u.slice())) : (c = qe(e)), a = 0, r = c.length;
            a < r;
            a++
        ) {
        ...
        n._bLoadingState ||
            ((e = {
                ...
                columns: n.aoColumns.map(function (e, t) {
                    return { visible: e.bVisible, search: B.extend({}, n.aoPreSearchCols[t]) };
                }),
            }),
            (n.oSavedState = e),
        ...
        if (e && e.time) {
            ...
            if (0 < l && e.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
                ...
                if (
                    ...
                    void 0 !== e.start && (null === i ? ((n._iDisplayStart = e.start), (n.iInitDisplayStart = e.start)) : Me(n, e.start / n._iDisplayLength)),
                    void 0 !== e.order &&
                        ((n.aaSorting = []),
    ...
    function Ge(e, t, n) {
        ...
        for (r in t)
            Object.prototype.hasOwnProperty.call(t, r) &&
                ((a = t[r]), B.isPlainObject(a) ? (B.isPlainObject(e[r]) || (e[r] = {}), B.extend(!0, e[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? (e[r] = a.slice()) : (e[r] = a));
        return e;
    }
    function Je(e, t, n) {
        B(e)
    ...
    function ee(t, e, n, a, r) {
        ...
        return (
            ...
            null !== n && ((e = B.Event(n + ".dt")), (n = B(t.nTable)), (e.dt = t.api), n[r ? "trigger" : "triggerHandler"](e, a), r && 0 === n.parents("body").length && B("body").trigger(e, a), o.push(e.result)),
            o
        );
    }
    function Ze(e) {
    ...
    (U = function (e, t) {
            ...
            var n,
                ...
                r = e
                    ? e.nTable && e.oFeatures
                        ...
                        ? e.settings().toArray()
                        : ("string" == typeof e ? (n = B(e).get()) : e instanceof B && (n = e.get()),
                          n
        ...
        (this.context = 1 < o.length ? x(o) : o), t && this.push.apply(this, t), (this.selector = { rows: null, cols: null, opts: null }), U.extend(this, this, et);
    }),
        ($.Api = U),
            ...
            iterator: function (e, t, n, a) {
                ...
                for ("string" == typeof e && ((a = n), (n = t), (t = e), (e = !1)), o = 0, i = h.length; o < i; o++) {
                    ...
                    if ("table" === t) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);
                        ...
                        for (c = this[o], "column-rows" === t && (u = ct(h[o], p.opts)), l = 0, s = c.length; l < s; l++)
                            (d = c[l]), void 0 !== (r = "cell" === t ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r);
                }
        ...
        (U.register = t = function (e, t) {
            if (Array.isArray(e)) for (var n = 0, a = e.length; n < a; n++) U.register(e[n], t);
            else
    ...
    function at(e, t, n, a, r) {
        for (var o, i, l, s, u = [], c = typeof t, d = 0, f = (t = t && "string" != c && "function" != c && void 0 !== t.length ? t : [t]).length; d < f; d++)
            for (l = 0, s = (i = t[d] && t[d].split && !t[d].match(/[[(:]/) ? t[d].split(",") : [t[d]]).length; l < s; l++)
    ...
    function rt(e) {
        return (e = e || {}).filter && void 0 === e.search && (e.search = e.filter), B.extend({ search: "none", order: "current", page: "all" }, e);
    }
    function ot(e) {
                ...
                : this.iterator(
                      ...
                      function (e) {
                          var t = B(e.nTable),
                              n = B(e.captionNode),
                              a = B(e.nTableWrapper);
                          n.length || ((n = B("<caption/>").html(r)), (e.captionNode = n[0]), o) || (t.prepend(n), (o = n.css("caption-side"))),
                              n.html(r),
                              o && (n.css("caption-side", o), (n[0]._captionSide = o)),
                              (a.find("div.dataTables_scroll").length ? ((e = "top" === o ? "Head" : "Foot"), a.find("div.dataTables_scroll" + e + " table")) : t).prepend(n);
                      },
                      1
                  );
        }),
        ...
        t("page.info()", function () {
            ...
            if (0 !== this.context.length)
                return (
                    ...
                    { page: (r = -1 === n) ? 0 : Math.floor(t / n), pages: r ? 1 : Math.ceil(a / n), start: t, end: e.fnDisplayEnd(), length: n, recordsTotal: e.fnRecordsTotal(), recordsDisplay: a, serverSide: "ssp" === te(e) }
                );
        }),
    ...
    function it(o, i, e, t) {
        function l(e, t) {
            var n;
            if (Array.isArray(e) || e instanceof B) for (var a = 0, r = e.length; a < r; a++) l(e[a], t);
            else
                e.nodeName && "tr" === e.nodeName.toLowerCase()
                    ? (e.setAttribute("data-dt-row", i.idx), s.push(e))
                    : ((n = B("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(t)), (B("td", n).addClass(t).html(e)[0].colSpan = H(o)), s.push(n[0]));
        }
        var s = [];
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                if ((r.off(t + " " + e + " " + a), h(l, "_details").length > 0)) {
                    ...
                    r.on(a, function (e, t) {
                        if (i !== t) return;
                        for (var n = 0, a = l.length; n < a; n++) if (l[n]._details) ht(r, n);
                    });
                }
                ft(n);
            }
    ...
    var ct = function (e, t) {
            ...
            } else if ("index" == l || "original" == l) for (u = 0, c = e.aoData.length; u < c; u++) e.aoData[u] && ("none" == i || (-1 === (n = r.indexOf(u)) && "removed" == i) || (0 <= n && "applied" == i)) && a.push(u);
            ...
            t("row().data()", function (e) {
                ...
                return void 0 === e
                    ? n.length && this.length && this[0].length
                        ...
                        : void 0
                    : (((t = n[0].aoData[this[0]])._aData = e), Array.isArray(e) && t.nTr && t.nTr.id && m(n[0].rowId)(e, t.nTr.id), pe(n[0], this[0], "data"), this);
            }),
            t("row().node()", function () {
                var e = this.context;
        ...
        gt =
                ...
                var t = this,
                    ...
                    e = this.iterator("column", function (e, t) {
                        ...
                        !(function (e, t, n) {
                            ...
                            if (n) for (var s = h(o, "bVisible").indexOf(!0, t + 1), u = 0, c = l.length; u < c; u++) l[u] && ((r = l[u].nTr), (a = l[u].anCells), r) && r.insertBefore(a[t], a[s] || null);
            ...
            t("cells()", function (g, e, m) {
                var a, r, o, i, l, s, t;
                return (
                    B.isPlainObject(g) && (void 0 === g.row ? ((m = g), (g = null)) : ((m = e), (e = null))),
                    ...
                    null == e
                                  ...
                                  at(
                                      ...
                                      function (e) {
                                          var t,
                                              n = "function" == typeof e;
                                          if (null == e || n) {
                                              for (o = [], i = 0, l = f.length; i < l; i++) for (r = f[i], s = 0; s < p; s++) (u = { row: r, column: s }), (!n || ((c = d[r]), e(u, G(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                                              return o;
                                          }
                        ...
                        : ((t = m ? { page: m.page, order: m.order, search: m.search } : {}),
                          ...
                          (t = this.iterator(
                              ...
                              function (e, t) {
                                  var n = [];
                                  for (o = 0, i = r[t].length; o < i; o++) for (l = 0, s = a[t].length; l < s; l++) n.push({ row: r[t][o], column: a[t][l] });
                                  return n;
                              },
                              1
                          )),
            ...
            t("cell().data()", function (e) {
                ...
                return void 0 === e
                    ? i.length && l.length
                        ...
                        : void 0
                    : ((t = i[0]), (n = l[0].row), (a = l[0].column), (r = t.aoColumns[a]), (o = t.aoData[n]._aData), r.fnSetData(o, e, { settings: t, row: n, col: a }), pe(i[0], l[0].row, "data", l[0].column), this);
            }),
            ...
            t(["columns().order()", "column().order()"], function (n) {
                ...
                return n
                    ...
                    : this.iterator(
                          "column",
                          function (e, t) {
                              for (var n = qe(e), a = 0, r = n.length; a < r; a++) if (n[a].col === t) return n[a].dir;
                              return null;
                          },
                          1
                      );
            ...
            t("search()", function (t, n, a, r) {
                ...
                return void 0 === t
                    ...
                    : this.iterator("table", function (e) {
                          e.oFeatures.bFilter &&
                              Le(e, "object" == typeof n ? B.extend(e.oPreviousSearch, n, { search: t }) : B.extend(e.oPreviousSearch, { search: t, regex: null !== n && n, smart: null === a || a, caseInsensitive: null === r || r }));
                      });
            }),
            ...
            e("columns().search()", "column().search()", function (a, r, o, i) {
                return this.iterator("column", function (e, t) {
                    ...
                    e.oFeatures.bFilter &&
                        ("object" == typeof r ? B.extend(n[t], r, { search: a }) : B.extend(n[t], { search: a, regex: null !== r && r, smart: null === o || o, caseInsensitive: null === i || i }), Le(e, e.oPreviousSearch));
                });
            }),
            ...
            pagingButton: {
                _: function (e, t, n, a, r) {
                    ...
                    return (
                        a && o.push(e.active),
                        r && o.push(e.disabled),
                        { display: (a = "ellipsis" === t ? B('<span class="ellipsis"></span>').html(n)[0] : B("<button>", { class: o.join(" "), role: "link", type: "button" }).html(n)), clicker: a }
                    );
                },
            },
            pagingContainer: {
        ...
        return function (a, r, o, i) {
            ...
            return (
                ...
                function (e, t) {
                    var n;
                    return (
                        null == e && (e = "--now" === i ? ((n = new Date()), new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ""),
                        "type" === t
                            ? l
                            : "" === e
                            ? "sort" !== t
                            ...
                            : !(null === r || a !== r || "sort" === t || "type" === t || e instanceof Date) || null === (n = Dt(e, a, o))
                            ? e
                            : "sort" === t
                            ? n
                            : ((e = null === r ? bt(n, "toDate", "toJSDate", "")[s]() : bt(n, "format", "toFormat", "toISOString", r)), "display" === t ? u(e) : e)
                    );
                }
            );
        };
            ...
            (($.type = function (a, e, t) {
                ...
                t || ((t = e), (e = null)),
                    "className" === e
                        ...
                        : "search" === e
                        ? n("search", t)
                        : e || (t.className && n("className", t.className), void 0 !== t.detect && r(t.detect), t.order && o(t.order), void 0 !== t.render && n("render", t.render), void 0 !== t.search && n("search", t.search));
            }),
            ($.types = function () {
                ...
                "disable" === f.attr("data-dt-order") ||
                    ...
                    B(d.nTable).on("order.dt.DT", function (e, t, n) {
                        ...
                        d === t &&
                            ...
                            -1 !== (s = l.indexOf(i.toArray().join(","))) && ((u = u.order()), f.addClass(u.includes("asc") ? c.isAsc : "" + u.includes("desc") ? c.isDesc : "")),
                            0 === s && l.length === i.count() ? ((u = n[0]), (c = a.asSorting), f.attr("aria-sort", "asc" === u.dir ? "ascending" : "descending"), (o = c[u.index + 1] ? "Reverse" : "Remove")) : f.removeAttr("aria-sort"),
            ...
            _: function (e, t, n) {
                ...
                B.each(n, function (e, t) {
                    ...
                    t.table && a.addClass("dt-layout-table"),
                        B("<div/>")
                            .attr({ id: t.id || null, class: "dt-layout-cell " + e + (t.className || "") })
                            .append(t.contents)
                            .appendTo(a);
                });
            },
            ...
            function (e, s) {
                ...
                return e.oFeatures.bInfo
                    ? ((t = e.oLanguage),
                      ...
                      (s = B.extend({ callback: t.fnInfoCallback, empty: t.sInfoEmpty, postfix: t.sInfoPostFix, search: t.sInfoFiltered, text: t.sInfo }, s)),
                      ...
                      B("#" + n + "_info", e.nWrapper).length || (u.attr({ "aria-live": "polite", id: n + "_info", role: "status" }), B(e.nTable).attr("aria-describedby", n + "_info")),
                      u)
                    : null;
            },
            "i"
    ...
    function At(e, t, n) {
        ...
        return (
            t <= n
                ...
                : (t - 1 - r <= e ? (a = f(t - (n - 2), t)) : ((a = f(e - r + 2, e + r - 1)).push("ellipsis", t - 1), a)).unshift(0, "ellipsis"),
            a
        );
    }
    $.feature.register(
        ...
        function (n, e) {
            ...
            return n.oFeatures.bFilter
                ? ((t = n.oClasses.search),
                  ...
                  -1 === (e = B.extend({ placeholder: c.sSearchPlaceholder, text: c.sSearch }, e)).text.indexOf("_INPUT_") && (e.text += "_INPUT_"),
                  (e.text = Ke(n, e.text)),
            ...
            function (e, t) {
                ...
                function n() {
                    !(function e(t, n, a) {
                        ...
                        h.length && 1 < a.numbers && B(n).outerHeight() >= 2 * B(h[0]).outerHeight() - 10 && e(t, n, B.extend({}, a, { numbers: a.numbers - 2 }));
                    })(e, a, t);
                }
    ...
    return (
        $.feature.register(
            ...
            function (a, e) {
                ...
                else for (p = 0; p < r.length; p++) B.isPlainObject(r[p]) ? (o.push(r[p].value), i.push(r[p].label)) : (o.push(r[p]), i.push(r[p]));
                for (
                    var l = e.text.match(/_MENU_$/),
                        s = e.text.match(/^_MENU_/),
                        u = e.text.replace(/_MENU_/, ""),
                        e = "<label>" + e.text + "</label>",
                        c = (s ? (e = "_MENU_<label>" + u + "</label>") : l && (e = "<label>" + u + "</label>_MENU_"), B("<div/>").addClass(t.container).append(e.replace("_MENU_", "<span></span>"))),
                        d = [],
                        f =
                        ...
                        h = B("<select/>", { name: n + "_length", "aria-controls": n, class: t.select }),
                        p = 0;
                    p < o.length;
                    p++
                )
